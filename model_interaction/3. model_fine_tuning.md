...
+ [Instruction Tuning](https://www.geeksforgeeks.org/artificial-intelligence/instruction-tuning-for-large-language-models/)
...
This project may take time to be completed, I understand and respect your time limitation. This hands-on practice project is to be designed in such a way that you just need to run and understand wrt to fine tuning.
