...
Meta Prompting – Prompt the model to write a better prompt.

Self-Consistency – Sample multiple CoT outputs and pick the best.

Tree of Thoughts – Explore multiple reasoning paths.

Program-Aided LMs – Combine code logic with text reasoning.

Active-Prompt / Automatic Prompt Engineer – AI optimizes the prompt for you.

Multimodal CoT – Reasoning across text + image + audio inputs.

Graph Prompting – For tasks involving structured graph-based thinking.

Directional Stimulus Prompting – Control tone/intent using prompt cues.
